	...
	public static void main(String[] args) {
		...
		// 2. Write SQL queries to create a DB Table!
			 ...
			 String sql3 = "INSERT INTO Employee " +
	                    "VALUES " +
	                    "(26, 'Doe', 'John', 'Manager', '123-456-7890', 'john.doe@gmail.com')," +
	                    "(8, 'Smith', 'Jane', 'Caretaker', '987-654-3210', 'jane.smith@gmail.com')," +
	                    "(45, 'Johnson', 'Michael', 'Assistant', '555-555-5555', 'michael.johnson@gmail.com')," +
	                    "(19, 'Williams', 'Emily', 'Trainer', '777-777-7777', 'emily.williams@gmail.com')," +
	                    "(37, 'Brown', 'David', 'Coordinator', '333-333-3333', 'david.brown@gmail.com')," +
	                    "(12, 'Lee', 'Sarah', 'Veterinarian', '444-444-4444', 'sarah.lee@gmail.com')," +
	                    "(3, 'Garcia', 'Robert', 'Volunteer', '666-666-6666', 'robert.garcia@gmail.com')," +
	                    "(31, 'Martinez', 'Olivia', 'Caretaker', '222-222-2222', 'olivia.martinez@gmail.com')," +
	                    "(22, 'Wilson', 'William', 'Assistant', '888-888-8888', 'william.wilson@gmail.com')," +
	                    "(49, 'Anderson', 'Ava', 'Trainer', '999-999-9999', 'ava.anderson@gmail.com')," +
	                    "(6, 'Lopez', 'Ethan', 'Coordinator', '777-888-9999', 'ethan.lopez@gmail.com')," +
	                    "(42, 'Thomas', 'Sophia', 'Veterinarian', '111-222-3333', 'sophia.thomas@gmail.com')," +
	                    "(15, 'Hall', 'Daniel', 'Volunteer', '444-555-6666', 'daniel.hall@gmail.com')," +
	                    "(29, 'Clark', 'Grace', 'Caretaker', '777-999-1111', 'grace.clark@gmail.com')," +
	                    "(5, 'Rodriguez', 'Liam', 'Assistant', '888-777-5555', 'liam.rodriguez@gmail.com')";
			 
			 String sql4 = "INSERT INTO AdoptionCenter " +
	                    "VALUES " +
	                    "(1, 'Paws and Claws', 'New York', 'Manager', '123-456-7890')," +
	                    "(2, 'Furry Friends', 'Los Angeles', 'Coordinator', '987-654-3210')," +
	                    "(3, 'Happy Tails', 'Chicago', 'Volunteer', '555-555-5555')," +
	                    "(4, 'Pets Haven', 'Houston', 'Caretaker', '777-777-7777')," +
	                    "(5, 'Animal Allies', 'San Francisco', 'Trainer', '333-333-3333')," +
	                    "(6, 'Pet Paradise', 'Miami', 'Veterinarian', '444-444-4444')," +
	                    "(7, 'Companion Care', 'Denver', 'Assistant', '666-666-6666')," +
	                    "(8, 'Rescue Ranch', 'Seattle', 'Caretaker', '222-222-2222')," +
	                    "(9, 'Forever Furry', 'Boston', 'Trainer', '888-888-8888')," +
	                    "(10, 'Pawsitive Vibes', 'Dallas', 'Volunteer', '999-999-9999')," +
	                    "(11, 'Cuddles and Co.', 'Austin', 'Manager', '111-111-1111')," +
	                    "(12, 'Whiskers and Wags', 'Portland', 'Coordinator', '222-222-2222')," +
	                    "(13, 'Furry Haven', 'Phoenix', 'Assistant', '333-333-3333')," +
	                    "(14, 'Pet Harmony', 'Las Vegas', 'Trainer', '444-444-4444')," +
	                    "(15, 'Tails of Joy', 'Atlanta', 'Veterinarian', '555-555-5555')";
			 ...
			 String sql5 = "INSERT INTO adoption_transaction "
			 		+ "VALUES "
						...
						+ "(88, '2023-05-01', 15.00, 60.00, 0.00, 75.00, 1008, 08, 26, 11),"
